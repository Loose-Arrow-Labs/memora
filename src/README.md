...
- `Memora.Import`: shared first-run import application services; currently repository attachment, with later M10 evidence intake, safety filtering, candidate generation, and readiness reporting built on the same boundary
